class PessoaJuridicasController < ApplicationController
  ...
  private
    ...
    def pessoa_juridica_params
      params.require(:pessoa_juridica).permit(:nome, :nome_fantasia, :nire, :data_nire, :incricao_estadual, :data_inscricao_estadual, :senha_estadual, :inscricao_municipa, :data_inscricao_municipal, :alvara, :data_alvara)
    end
end
